...
from dynamix.sparse import dense_to_space, dense_to_times, space_to_dense, times_to_dense, space_to_times
...
def suite():
    ...
    testsuite.addTest(
        unittest.defaultTestLoader.loadTestsFromTestCase(TestSparseFormats)
    )
    return testsuite
